...
stanmodels <- c("alt_g", "alt_gl", "marg_dr_npp_g4", "marg_dr_npp_gl4", "marg_dr_pp_g4", "marg_dr_pp_gl4", "marg_dr_pp_glpknown", "marg_ndr_npp_g4", "marg_ndr_npp_gl4", "marg_ndr_pp_g4", "marg_ndr_pp_gl4")
...
Rcpp::loadModule("stan_fit4marg_dr_pp_glpknown_mod", what = TRUE)
