...
stanmodels <- c("alt_g", "alt_gl", "marg_dr_npp_g4", "marg_dr_npp_gl4", "marg_dr_npp_glpknown4", "marg_dr_pp_g4", "marg_dr_pp_gl4", "marg_dr_pp_glpknown4", "marg_ndr_npp_g4", "marg_ndr_npp_gl4", "marg_ndr_npp_glpknown4", "marg_ndr_pp_g4", "marg_ndr_pp_gl4", "marg_ndr_pp_glpknown4")
...
Rcpp::loadModule("stan_fit4marg_ndr_npp_g4_mod", what = TRUE)
Rcpp::loadModule("stan_fit4marg_ndr_npp_gl4_mod", what = TRUE)
Rcpp::loadModule("stan_fit4marg_ndr_npp_glpknown4_mod", what = TRUE)
