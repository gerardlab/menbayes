...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_alt_g");
    reader.add_event(16, 14, "end", "model_alt_g");
    return reader;
}
#include <stan_meta_header.hpp>
class model_alt_g
  : public stan::model::model_base_crtp<model_alt_g> {
private:
        int K;
        std::vector<int> x;
        vector_d beta;
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            x = std::vector<int>((K + 1), int(0));
            vals_i__ = context__.vals_i("x");
            pos__ = 0;
            size_t x_k_0_max__ = (K + 1);
...
typedef model_alt_g_namespace::model_alt_g stan_model;
#ifndef USING_R
