...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(83, 81, "end", "model_marg_ndr_pp_glpknown4");
    return reader;
}
...
class model_marg_ndr_pp_glpknown4
  : public stan::model::model_base_crtp<model_marg_ndr_pp_glpknown4> {
private:
        int N;
        matrix_d gl;
        int g1;
...
public:
    ...
    std::string model_name() const {
        return "model_marg_ndr_pp_glpknown4";
    }
...
typedef model_marg_ndr_pp_glpknown4_namespace::model_marg_ndr_pp_glpknown4 stan_model;
#ifndef USING_R
