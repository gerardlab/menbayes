...
namespace model_pp_nodr_f1_g4_pknown_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_pp_nodr_f1_g4_pknown");
    reader.add_event(78, 76, "end", "model_pp_nodr_f1_g4_pknown");
    return reader;
}
...
class model_pp_nodr_f1_g4_pknown
  : public stan::model::model_base_crtp<model_pp_nodr_f1_g4_pknown> {
private:
        std::vector<int> x;
        double ppbound;
        int g1;
        int g2;
public:
    model_pp_nodr_f1_g4_pknown(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_pp_nodr_f1_g4_pknown_namespace::model_pp_nodr_f1_g4_pknown";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_pp_nodr_f1_g4_pknown_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_pp_nodr_f1_g4_pknown";
    }
...
typedef model_pp_nodr_f1_g4_pknown_namespace::model_pp_nodr_f1_g4_pknown stan_model;
#ifndef USING_R
