...
namespace model_marg_dr_pp_glpknown_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marg_dr_pp_glpknown");
    reader.add_event(85, 83, "end", "model_marg_dr_pp_glpknown");
    return reader;
}
...
class model_marg_dr_pp_glpknown
  : public stan::model::model_base_crtp<model_marg_dr_pp_glpknown> {
private:
        int N;
        matrix_d gl;
        double drbound;
        ...
        int g2;
public:
    model_marg_dr_pp_glpknown(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_marg_dr_pp_glpknown_namespace::model_marg_dr_pp_glpknown";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_marg_dr_pp_glpknown_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_marg_dr_pp_glpknown";
    }
...
typedef model_marg_dr_pp_glpknown_namespace::model_marg_dr_pp_glpknown stan_model;
#ifndef USING_R
