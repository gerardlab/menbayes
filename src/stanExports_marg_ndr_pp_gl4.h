...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marg_ndr_pp_gl4");
    reader.add_event(94, 92, "end", "model_marg_ndr_pp_gl4");
    return reader;
}
...
class model_marg_ndr_pp_gl4
  : public stan::model::model_base_crtp<model_marg_ndr_pp_gl4> {
private:
        int N;
        vector_d p1_gl;
        vector_d p2_gl;
...
typedef model_marg_ndr_pp_gl4_namespace::model_marg_ndr_pp_gl4 stan_model;
#ifndef USING_R
