...
namespace model_pp_f1_gl4_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_pp_f1_gl4");
    reader.add_event(98, 96, "end", "model_pp_f1_gl4");
    return reader;
}
...
class model_pp_f1_gl4
  : public stan::model::model_base_crtp<model_pp_f1_gl4> {
private:
        int N;
        vector_d p1_gl;
        vector_d p2_gl;
        ...
        double mixprop;
public:
    model_pp_f1_gl4(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_pp_f1_gl4_namespace::model_pp_f1_gl4";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_pp_f1_gl4_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_pp_f1_gl4_namespace::model_pp_f1_gl4 stan_model;
#ifndef USING_R
