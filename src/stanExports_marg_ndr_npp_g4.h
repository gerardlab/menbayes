...
namespace model_marg_ndr_npp_g4_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marg_ndr_npp_g4");
    reader.add_event(72, 70, "end", "model_marg_ndr_npp_g4");
    return reader;
}
...
class model_marg_ndr_npp_g4
  : public stan::model::model_base_crtp<model_marg_ndr_npp_g4> {
private:
        std::vector<int> x;
        int g1;
        int g2;
public:
    model_marg_ndr_npp_g4(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_marg_ndr_npp_g4_namespace::model_marg_ndr_npp_g4";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_marg_ndr_npp_g4_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_marg_ndr_npp_g4_namespace::model_marg_ndr_npp_g4 stan_model;
#ifndef USING_R
