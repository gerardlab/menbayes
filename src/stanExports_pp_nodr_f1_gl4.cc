...
#include "stanExports_pp_nodr_f1_gl4.h"

RCPP_MODULE(stan_fit4pp_nodr_f1_gl4_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_pp_nodr_f1_gl4")
