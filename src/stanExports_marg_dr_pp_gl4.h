...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marg_dr_pp_gl4");
    reader.add_event(98, 96, "end", "model_marg_dr_pp_gl4");
    return reader;
}
...
class model_marg_dr_pp_gl4
  : public stan::model::model_base_crtp<model_marg_dr_pp_gl4> {
private:
        int N;
        vector_d p1_gl;
        vector_d p2_gl;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= 5; ++i) {
                ...
                stan::math::assign(p1, segfreq4(alpha, xi, (i - 1), pstream__));
                ...
                for (int j = 1; j <= 5; ++j) {
                    ...
                    stan::math::assign(p2, segfreq4(alpha, xi, (j - 1), pstream__));
...
typedef model_marg_dr_pp_gl4_namespace::model_marg_dr_pp_gl4 stan_model;
#ifndef USING_R
