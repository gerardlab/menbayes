...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_alt_gl");
    reader.add_event(23, 21, "end", "model_alt_gl");
    return reader;
}
#include <stan_meta_header.hpp>
class model_alt_gl
  : public stan::model::model_base_crtp<model_alt_gl> {
private:
        int N;
        int K;
        matrix_d gl;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("q", "(K + 1)", (K + 1));
        context__.validate_dims("parameter initialization", "q", "vector_d", context__.to_vec((K + 1)));
        ...
        try {
            writer__.simplex_unconstrain(q);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            // model parameters
            current_statement_begin__ = 9;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> q;
            (void) q;  // dummy to suppress unused var warning
            if (jacobian__)
                q = in__.simplex_constrain((K + 1), lp__);
            else
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> q = in__.simplex_constrain((K + 1));
        size_t q_j_1_max__ = (K + 1);
        for (size_t j_1__ = 0; j_1__ < q_j_1_max__; ++j_1__) {
...
typedef model_alt_gl_namespace::model_alt_gl stan_model;
#ifndef USING_R
