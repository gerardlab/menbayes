...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marg_dr_npp_glpknown4");
    reader.add_event(81, 79, "end", "model_marg_dr_npp_glpknown4");
    return reader;
}
...
class model_marg_dr_npp_glpknown4
  : public stan::model::model_base_crtp<model_marg_dr_npp_glpknown4> {
private:
        int N;
        matrix_d gl;
        double drbound;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(p1, segfreq4(alpha, g1, pstream__));
            current_statement_begin__ = 73;
            stan::math::assign(p2, segfreq4(alpha, g2, pstream__));
    ...
    std::string model_name() const {
        return "model_marg_dr_npp_glpknown4";
    }
...
typedef model_marg_dr_npp_glpknown4_namespace::model_marg_dr_npp_glpknown4 stan_model;
#ifndef USING_R
