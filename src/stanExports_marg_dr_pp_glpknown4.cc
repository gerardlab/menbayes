...
#include "stanExports_marg_dr_pp_glpknown4.h"

RCPP_MODULE(stan_fit4marg_dr_pp_glpknown4_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_marg_dr_pp_glpknown4")
