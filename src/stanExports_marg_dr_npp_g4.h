...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marg_dr_npp_g4");
    reader.add_event(78, 76, "end", "model_marg_dr_npp_g4");
    return reader;
}
...
class model_marg_dr_npp_g4
  : public stan::model::model_base_crtp<model_marg_dr_npp_g4> {
private:
        std::vector<int> x;
        double drbound;
        int g1;
...
typedef model_marg_dr_npp_g4_namespace::model_marg_dr_npp_g4 stan_model;
#ifndef USING_R
