...
namespace model_marg_ndr_npp_glpknown4_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_marg_ndr_npp_glpknown4");
    reader.add_event(74, 72, "end", "model_marg_ndr_npp_glpknown4");
    return reader;
}
Eigen::Matrix<double, Eigen::Dynamic, 1>
segfreq4(const int& g, std::ostream* pstream__) {
...
struct segfreq4_functor__ {
            Eigen::Matrix<double, Eigen::Dynamic, 1>
    operator()(const int& g, std::ostream* pstream__) const {
        return segfreq4(g, pstream__);
    }
};
...
class model_marg_ndr_npp_glpknown4
  : public stan::model::model_base_crtp<model_marg_ndr_npp_glpknown4> {
private:
        int N;
        matrix_d gl;
        int g1;
        int g2;
public:
    model_marg_ndr_npp_glpknown4(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_marg_ndr_npp_glpknown4_namespace::model_marg_ndr_npp_glpknown4";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(p1, segfreq4(g1, pstream__));
            current_statement_begin__ = 67;
            stan::math::assign(p2, segfreq4(g2, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_marg_ndr_npp_glpknown4_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_marg_ndr_npp_glpknown4";
    }
...
typedef model_marg_ndr_npp_glpknown4_namespace::model_marg_ndr_npp_glpknown4 stan_model;
#ifndef USING_R
