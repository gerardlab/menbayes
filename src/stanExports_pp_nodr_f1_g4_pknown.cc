...
#include "stanExports_pp_nodr_f1_g4_pknown.h"

RCPP_MODULE(stan_fit4pp_nodr_f1_g4_pknown_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_pp_nodr_f1_g4_pknown")
